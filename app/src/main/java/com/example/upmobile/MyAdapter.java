...
import com.example.upmobile.PhotoActivity;
...
public class MyAdapter extends ArrayAdapter<Photo> {
    ...
    public MyAdapter(Activity activity, Context context, List<Photo> data) {
        super(context, R.layout.images_item, data);
        mActivity = activity;
        mContext = context;
        mData = data;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            view = LayoutInflater.from(getContext()).inflate(R.layout.images_item, parent, false);
